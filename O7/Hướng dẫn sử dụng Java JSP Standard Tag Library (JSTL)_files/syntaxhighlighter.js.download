...
SyntaxHighlighter.brushes.Properties = function()
{
    // Contributed by Nicolas Perriault
...
SyntaxHighlighter.brushes.Properties.prototype  = new SyntaxHighlighter.Highlighter();
SyntaxHighlighter.brushes.Properties.aliases    = ['properties'];
